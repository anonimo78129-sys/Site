#!/usr/bin/env python3
"""Gera o folder "Conheca o Prof. Corujao" em PDF.

Dobra simples (cartao): folha de 303 x 216 mm (A4 deitado com 3 mm de
sangria), dois lados, dois paineis A5 por lado. Le folder/folder-conheca.html,
reduz as imagens do repositorio para uma resolucao adequada a impressao,
monta uma copia temporaria do site e renderiza com o Chromium headless.

Uso:
  python3 folder/gerar_folder_conheca.py           arte final, sem marcas
  python3 folder/gerar_folder_conheca.py --guias   prova com corte, dobra e margem

Saida: folder/folder-conheca.pdf
       folder/folder-conheca-guias.pdf
"""
import os
import re
import shutil
...
SRC = os.path.join(HERE, 'folder-conheca.html')
OUT = os.path.join(HERE, 'folder-conheca.pdf')
OUT_GUIAS = os.path.join(HERE, 'folder-conheca-guias.pdf')
